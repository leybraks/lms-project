...
function HomePage() {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        setError('No se pudieron cargar los datos de tu dashboard.');
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%', width: '100%' }}>
      ...
      {/* 2. FILA SUPERIOR DE WIDGETS (versión flexible con grid) */}
      <Box
        sx={{
          display: 'grid',
      ...
      >
        ...
        <Paper sx={{ p: 3, borderRadius: 4, textAlign: 'center', height: '100%' }}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', gap: 1, alignItems: 'center', mt: 2 }}>
            ...
            <Avatar sx={{ bgcolor: 'grey.700', width: 48, height: 48 }}>
              <Typography variant="h5">❓</Typography>
            </Avatar>
          </Box>
        </Paper>
        ...
        <Paper sx={{ p: 3, borderRadius: 4, textAlign: 'center', height: '100%' }}>
          ...
          <Typography variant="h2" sx={{ fontSize: '3rem', lineHeight: 1, mt: 1 }}>
            🥚
          </Typography>
      ...
      <Grid container spacing={4} sx={{ flex: 1, overflow: 'hidden', minHeight: 0 }}>
        {/* IZQUIERDA */}
        <Grid item xs={12} sm={7} md={8} sx={{ height: '100%', overflowY: 'auto' }}>
          {/* Calendario */}
          <Paper sx={{ p: 4, mb: 4, borderRadius: 5, background: 'linear-gradient(90deg, #6750A4 0%, #A06EFE 100%)', color: 'white' }}>
        ...
        {/* DERECHA */}
        <Grid item xs={12} sm={5} md={4} sx={{ height: '100%', overflowY: 'auto' }}>
          {/* Estadísticas */}
          <Paper sx={{ p: 3, mb: 4, borderRadius: 5, textAlign: 'center' }}>
          ...
          {/* Mentores */}
          <Paper sx={{ p: 3, mb: 4, borderRadius: 5 }}>
          ...
          {/* Lecciones próximas */}
          <Paper sx={{ p: 3, borderRadius: 4, textAlign: 'center', mb: 4 }}>
            <Typography variant="h6" sx={{ fontWeight: 600 }}>
              Lecciones Próximas
            </Typography>
